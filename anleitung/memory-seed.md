# Memory-Seed — ChatGPT Project Memory

> Einmal in **Project Memory** setzen (oder bei Drift ersetzen).  
> **Nicht** ins Project als Datei hochladen — Copy-Paste.
...
- [ ] Memory enthält **keine** Ticker/Cash/PV/pnl?
- [ ] Nach Regel-Update: Seed ggf. erneuern
- [ ] Instructions + operator-core/protocol aktuell im Project?

**Prinzip:** Memory = Betriebssystem · Files = Buchhaltung
